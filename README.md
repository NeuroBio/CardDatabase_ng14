...
2022-09-01: I ended up in a really bad spot with the repository, where it was using angular 12, my gloabal CLI was 13, and I trying to update to 14.  It was causing catatrophic failures, and I could not get back into a position where I could build the app.  I ended up creating a new angular 14 app, copied the firebase pattern I had working in my ng 13 app and then bit by bit migrated my components over, forcing them to comply to the latest typescript requirements.  I'm not happy with the state of the code due to this but I have a functional repository again.  It also means I've lost the original commit history here, though I have it archived in a private repo.
